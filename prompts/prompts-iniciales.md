Estamos desarrollando una API para un Sistema de Seguimiento de Talendo (ATS)

Para el caso de uso Añadir candidato al sistema se detalla:

**Como** reclutador (recruiter)
**Quiero** tener la capacidad de añadir candidatos (applicant) al sistema ATS
**Para que** pueda gestionar sus datos y procesos de selección.
...
Enumera las tareas necesarias a seguir para realizar este caso de uso separandolas por tareas para el frontend, backend y bbdd teniendo en cuenta que la bbdd esta definida en la carpeta prisma.

Antes de realizar cualquier tarea pregunta las dudas y detalla bien los pasos.
